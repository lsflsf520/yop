...
public class InstantPayService {
	 ...
	 * @return
	 */
	public static String getFcallbackURL(){
		return Configuration.getInstance().getValue("yeepay.page.callback.url");
	}
	...
	public static String getCallbackURL(){
		return Configuration.getInstance().getValue("yeepay.callback.url");
	}
	...
	public static String getPaymobileRequestURL(Map<String, String> params) {
		...
		if(StringUtils.isBlank(params.get("fcallbackurl"))){
			String fcallbackURL = getFcallbackURL();
			params.put("fcallbackurl", fcallbackURL);
		}
		if(StringUtils.isBlank(params.get("callbackurl"))){
			String callbackURL = getCallbackURL();
			
			params.put("callbackurl", callbackURL);
		}
//		LogUtils.info("requestURL:%s, params:%s", requestURL, params);
		...
		LogUtils.debug("yeepay params: " + dataMap);
...
//		String merchantAESKey		= getMerchantAESKey();
		...
		LogUtils.info("callbackResult:%s", callbackResult);
